...
static int luaB_tonumber (lua_State *L) {
  ...
  if (base == 10) {  /* standard conversion */
    ...
    /* ILP32 port: unsigned long is 32-bit on wasm32 and strtoul wraps
       negative values (tonumber('-10', 36) returned 4294967260). strtoll
       gives the LP64 behavior the suite expects. */
    n = strtoll(s1, &s2, base);
