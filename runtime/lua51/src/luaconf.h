...
/* WASI port: tmpnam/L_tmpnam are not defined; the harness stubs os.tmpname
   at runtime anyway (runtime/luawasm.c install_shims). */
#define LUA_TMPNAMBUFSIZE	32
#define lua_tmpnam(b,e)	{ strcpy(b, "testdiff.tmp"); e = 0; }
